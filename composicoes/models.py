...
class MaodeObraCusto(models.Model):
    ...
    periculosidade_insalubridade = models.DecimalField(max_digits=7,
                                                       decimal_places=6, verbose_name="Periculosidade/Insalubridade")
...
class EquipamentoCusto(models.Model):
    ...
    valor_aquisicao = models.DecimalField(max_digits=20, decimal_places=4, null=True, blank=True,
                                          verbose_name="Valor de Aquisição")
    depreciacao = models.DecimalField(max_digits=20, decimal_places=4, null=True, blank=True,
                                      verbose_name="Depreciação")
    oportunidade_capital = models.DecimalField(max_digits=20, decimal_places=4, null=True, blank=True,
                                               verbose_name="Oportunidade de Capital")
    seguro_e_impostos = models.DecimalField(max_digits=20, decimal_places=4, null=True, blank=True,
                                            verbose_name="Seguro e Impostos")
    ...
    mao_de_obra_de_operacao = models.DecimalField(max_digits=20, decimal_places=4, null=True, blank=True,
                                                  verbose_name="Mão de Obra de Operação")
...
class AtividadeAuxiliarRelacaoComp(models.Model):
    ...
    atividade_aux = models.ForeignKey(Sicro, on_delete=models.PROTECT, verbose_name='Código Atividade Auxiliar',
                                      related_name='atividades_auxiliares')
    quantidade = models.DecimalField(max_digits=20, decimal_places=5)
    tempo_fixo = models.ForeignKey(Sicro, on_delete=models.PROTECT, null=True, blank=True,
                                   related_name='tempos_fixos_aux')
    quantidade_tempo_fixo = models.DecimalField(max_digits=20, decimal_places=5, null=True, blank=True)
